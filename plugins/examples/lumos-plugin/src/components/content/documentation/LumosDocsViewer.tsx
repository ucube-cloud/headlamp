...
export function LumosDocsViewer({ keyword }: LumosDocsViewerProps) {
  ...
  async function handleSearch() {
    ...
    console.log('Transformed definitionsArray:', definitionsArray);
  ...
  function RenderSearchResults({ searchData }: { searchData: any }) {
      ...
      function handleChosenResource() {
        ...
        searchDataArray.forEach((key: any) => {
          ...
          if (searchItem.kind === name && searchItem.value === value) {
            console.log('choosing resource', searchItem);
      ...
      return (
        ...
        >
          ...
          >
            ...
            <CardActions>
              <Button size="small" onClick={handleChosenResource}>
                Learn More
              </Button>
            </CardActions>
          </Card>
    ...
    return (
      ...
      >
        ...
        >
          Search results for: <Typography></Typography>
        </Typography>
        <Box
          sx={{
            display: 'flex',
